...
class Settings:
    ...
    # ---- solver runtime ----
    solver_runtime_enabled: bool = True
    solver_runtime_workers: int = 1
    solver_runtime_start_method: str = "spawn"
    solver_runtime_timeout_sec: float = 30.0
    solver_runtime_warm_start: bool = True
    solver_runtime_use_for_preflop: bool = False
